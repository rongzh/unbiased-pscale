...
# plt.scatter(Table4_v,np.ones(len(Table4_v))*i,c = p_diff_Jam[:,ind],marker='+')
...
#const_array_D = [param_dic['const']['Natom'],param_dic['const']['Cv_max_cell']*param_dic['const']['fcv'],param_dic['const']['P_factor'] ]
Dewaele_dic = dict()
# Dewaele_report = [74.71*4, 161.0,3.94,800,1.45,0.8]
...
# plt.plot(Fig1_MgO_dat[:,0],Fig1_MgO_dat[:,1])
# plt.show()
