...
def set_const(param_d):
  ...
  param_d['P_conv_Fac'] = 160.217657*6.24*10**(18) #GPa in 1 J/Ang^3
  param_d['C_DP'] = 3*param_d['kB']*param_d['Natom']*param_d['P_conv_Fac']
...
def MGD_PowerLaw(volume, temperature,param_d):
...
def MGD_PowerLawShifted(volume, temperature, param_d):
